/* ============================================================
   ...
   price  — только одно число, кратное 100 (без «от» и «до»)
   ...
   Ценовая политика с 26.09.2026: прежний прайс +500 ₽, округление вверх до сотни, одна цена на позицию.
   ============================================================ */
window.MAMA_PRICES = [
  // ── Шляпные коробки ────────────────────────────────────────
  ...
  { tab: "bouquet", name: "Мини-букет", desc: "Небольшой букетик: маленький повод, большая радость", price: 1300, unit: "", photo: "img/mini-bouquet.webp", art: "bouquet" },

  // ── Ассорти ────────────────────────────────────────────────
  { tab: "assorti", name: "Коробка ассорти 20×20", desc: "Цветы, мандаринки и формы разных вкусов", price: 1800, unit: "", photo: "img/assorti-box.webp", art: "box" },
  ...
  // ── Штучное ────────────────────────────────────────────────
  { tab: "piece", name: "Клубничные сердечки", desc: "Хит к 14 февраля, в пакетике с атласной лентой", price: 600, unit: "/шт", photo: "img/hearts.webp", art: "heart" },
  { tab: "piece", name: "Купол с цветком", desc: "Роза, тюльпан, ёлочка или гномик под куполом", price: 800, unit: "", photo: "img/domes.webp", art: "dome" },
  { tab: "piece", name: "Зефирная «восьмёрка»", desc: "Маленький подарок к 8 Марта", price: 700, unit: "/шт", photo: "img/eight.webp", art: "eight" },
  { tab: "piece", name: "Зефирный рожок", desc: "Мороженое, которое не тает", price: 900, unit: "", photo: "img/cone.webp", art: "cone" },
  ...
  { tab: "season", name: "Пасхальное гнездо", desc: "Зефирное гнёздышко со съедобными яйцами с миндалём", price: 700, unit: "/шт", photo: "img/easter-nests.webp", art: "nest" },
  { tab: "season", name: "Мини-кулич", desc: "Апельсиновое песочное печенье, шоколад и зефир. Диаметр 6 см, высота 11 см", price: 800, unit: "/шт", photo: "img/kulichi.webp", art: "kulich" }
];
